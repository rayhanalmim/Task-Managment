...
const Home = () => {
    ...
    return (
        <div>
            <div className="bg-[url('https://i.ibb.co/P1yRjtn/jason-goodman-vbxy-Fxlgpj-M-unsplash-scaled-e1695364489124.webp')] bg-cover bg-center h-3/4 md:h-full w-full rounded">
                <div className="text-center inset-0 bg-black bg-opacity-60 bg-blend-multiply py-36 space-y-3">
                    ...
                    <div>
                        {
                            user ? <button className="btn btn-active hover:bg-[#01013D] btn-secondary bg-gray-900 border-0 tracking-widest">Let’s Explore</button> :
                                <Link to='/SingIn'><button className="btn btn-active hover:bg-[#01013D] btn-secondary bg-[#00008B] border-0 tracking-widest">Let’s Explore</button></Link>
                        }
                    </div>
                </div>
            </div>

            <footer className="footer bg-neutral footer-center p-4 text-gray-100">
                <aside>
